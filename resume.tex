...
%----------------------------------------------------------------------------------------
    ...
    \begin{rSection}{Experience}
        ...
        \begin{rSubsection}{Airbus Defence \& Space}{February 2026 - May 2026}{Incoming full-time internship – Cybersecurity Engineer (A400M Programme)}{Getafe, Spain}
            \item Upcoming 3-month cybersecurity internship on the A400M military transport aircraft programme.
            \item Exposure to secure systems engineering in a highly regulated defence environment and international context.
        \end{rSubsection}
...
%----------------------------------------------------------------------------------------
    ...
    \begin{rSection}{Technical Skills}
        ...
        \begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
            ...
            Systems & GNU/Linux (Debian, Ubuntu), server environments, shell scripting, Ansible \\
            Cybersecurity & VPN, system hardening, access management, cryptography, defence context (A400M) \\
