...
%----------------------------------------------------------------------------------------
    ...
    \begin{rSection}{Expérience professionnelle}
        ...
        \begin{rSubsection}{Airbus Defence \& Space}{Février 2026 - Mai 2026}{Stage temps plein – Ingénieur cybersécurité (programme A400M)}{Getafe, Espagne}
            \item Mission de 4 mois en cybersécurité pour soutenir les opérations de maintenance A400M sur le site de production de Getafe (Espagne).
            ...
            \item Conception / Maintenance de VPN IPSec et configuration NAT sur des équipements FortiGate afin de sécuriser et interconnecter les systèmes de maintenance.
